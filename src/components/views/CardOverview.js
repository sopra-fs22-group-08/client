    ...
    let burgerMenuContent = (
        <BaseContainer>
            ...
            <Button
                ...
                onClick={() => {
                    setBurgerMenu(false);
                    toProfile(localStorage.getItem('userId'));
                }}
            >
                {user?.username ? user.username : 'Username'}
            </Button>
            <Button className='cardOverview home' onClick={() => goHome()}>
                Home
            </Button>
            <Button className='Home public-decks' onClick={() => goPublicDecks()}>
                Public Decks
            </Button>
            <Button className='cardOverview creator' onClick={() => goCreator()}>
                Creator
            </Button>
            <Button className='cardOverview logoutButton' onClick={() => logout()}>
                Logout
            </Button>
            <div className='cardOverview x' onClick={() => setBurgerMenu(false)}>
                x
            </div>
        </BaseContainer>
    );
